---
title: "Mouse_DESEQ_results_script"
author: "CM"
date: "2025-03-17"
...
knitr::opts_chunk$set(eval=FALSE, echo = TRUE) # I HAVE EVAL SET TO FALSE FOR TESTING REASONS!!
library(IRanges)
library(dplyr)
library(tidyr)
library(tibble)
...
# Goal:
I want to use this [script](/scratch/Shares/rinnclass/MASTER_CLASS/lessons/06_Differential_expression_analyses) and change it so that our file paths are right. We'll do counts data first, then do TPM.
