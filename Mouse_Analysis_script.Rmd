...
save(MS_dds, MS_res_df, file = "/scratch/Shares/rinnclass/MASTER_CLASS/STUDENTS/genehomies/RESULTS/MS_vs_HS/ML/MS_LRT_res_df.RData")
```
...
# Calculate the maximum fold-change in any one timepoint
  ...
  save(MS_sig, MS_filtered_res_df, file = "/scratch/Shares/rinnclass/MASTER_CLASS/STUDENTS/genehomies/RESULTS/MS_vs_HS/ML/MS_sig.RData")
```
...
save(human_dds, human_res_df, file = "/scratch/Shares/rinnclass/MASTER_CLASS/STUDENTS/genehomies/RESULTS/MS_vs_HS/ML/human_LRT_res_df.RData")
```
...
# Calculate the maximum fold-change in any one timepoint
  ...
  save(human_sig, human_filtered_res_df, file = "/scratch/Shares/rinnclass/MASTER_CLASS/STUDENTS/genehomies/RESULTS/MS_vs_HS/ML/human_sig.RData")
```
...
save(tx2gene, gencode_synteny_filtered, human_common_sig, MS_common_sig, file = "/scratch/Shares/rinnclass/MASTER_CLASS/STUDENTS/genehomies/RESULTS/MS_vs_HS/ML/gencode_synteny_filtered.RData")
```
...
save(synteny, common_sig, human_common_sig_lncrna, MS_common_sig_lncrna, file = "/scratch/Shares/rinnclass/MASTER_CLASS/STUDENTS/genehomies/RESULTS/MS_vs_HS/ML/common_lncRNA.RData")
```
...
save(orthologs_filtered, human_common_sig_PCG, MS_common_sig_PCG, file = "/scratch/Shares/rinnclass/MASTER_CLASS/STUDENTS/genehomies/RESULTS/MS_vs_HS/ML/common_PCG.RData")
```
...
save(human_combined_sig, MS_combined_sig, file = "/scratch/Shares/rinnclass/MASTER_CLASS/STUDENTS/genehomies/RESULTS/MS_vs_HS/ML/combined_sig.RData")
```
...
# Save the plot
ggsave(
  path = "/scratch/Shares/rinnclass/MASTER_CLASS/STUDENTS/genehomies/RESULTS/MS_vs_HS/ML/figures/",
